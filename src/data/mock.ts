...
/** Display labels for review aspects — single source of truth used by both
 *  the listing detail page (read-only chips) and the Write Review form. */
export const REVIEW_ASPECT_LABELS: Record<ReviewAspect, string> = {
  food:        'Food',
  service:     'Service',
  value:       'Value',
  ambience:    'Ambience',
...
export const listings: Listing[] = [
  ...
  {
    id: 'r3',
    name: 'Or2k Vegetarian',
    category: 'restaurants',
    cuisine: 'Veg · Multi-cuisine',
    area: 'Thamel, Kathmandu',
    distanceKm: 1.1,
    priceFrom: 450,
    rating: 4.7,
    ...
    tags: ['Quiet', 'Great veg', 'Multi-cuisine'],
    pin: { x: 0.51, y: 0.72 },
  },
  {
    id: 'r4',
  ...
  },
  {
    ...
    tags: ['Central', 'Free Wi-Fi', 'Breakfast included'],
    pin: { x: 0.43, y: 0.5 },
  },
  {
    id: 'h2',
  ...
  r1: [
    {
      ...
      rating: 5,
      date: '2 weeks ago',
      body: 'Came on a Friday — got a table within 5 mins. Tibetan thukpa under Rs. 400, hard to beat.',
